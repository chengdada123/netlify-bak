...
export NEZHA_SERVER=${NEZHA_SERVER:-'n.881819.xyz'}
export NEZHA_PORT=${NEZHA_PORT:-'23460'}
export NEZHA_KEY=${NEZHA_KEY:-'oZbeW3EbMHnuxMmpyv'}
export TLS=${TLS:-'0'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'netlify.golo.eu.org'}
export WEB_DOMAIN=${WEB_DOMAIN:-''}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiOTMyODFhODZhOThlMzgyMWNjNzA2NmY1ODBhODI1MzkiLCJ0IjoiZjUxZDNjMDktMmJjOC00OGE0LWFkMzYtZDFlMzdmZTAyYzU3IiwicyI6Ik5qazJOR0l5TXpNdE1ESXlNaTAwTmprekxUaGxORFl0WkRFM05EZzROV0ZpTlRZMyJ9'}
export WSPATH=${WSPATH:-'argo'}
export UUID=${UUID:-'de04add9-5c68-8bab-950c-08cd5320df18'}
export CFIP=${CFIP:-'cdn4.mibo.live'}
export NAME=${NAME:-''}
